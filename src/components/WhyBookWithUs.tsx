			...
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				<div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-start">
						...
						<div className="mt-10 flex items-center gap-4">
							<div className="flex -space-x-3">
								<div className="h-12 w-12 overflow-hidden rounded-full ring-2 ring-white shadow">
									<Image src="/images/hero/heroOne.jpg" alt="Traveler avatar" width={48} height={48} className="h-full w-full object-cover" />
								</div>
								<div className="h-12 w-12 overflow-hidden rounded-full ring-2 ring-white shadow">
									<Image src="/images/hero/heroTwo.jpg" alt="Traveler avatar" width={48} height={48} className="h-full w-full object-cover" />
								</div>
								<div className="h-12 w-12 overflow-hidden rounded-full ring-2 ring-white shadow">
									<Image src="/images/hero/heroThree.jpg" alt="Traveler avatar" width={48} height={48} className="h-full w-full object-cover" />
								</div>
							</div>
							<p className="text-teal-900/90 text-base sm:text-lg">
								Join the <span className="font-extrabold">78,000+</span> travelers who’ve let us handle their dream trips!
							</p>
						</div>
					</div>
					...
					<div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
						<FeatureCard
							icon={
								<span className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-teal-100 text-teal-700">★</span>
							}
						...
						<FeatureCard
							icon={
								<span className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-teal-100 text-teal-700">✉️</span>
							}
