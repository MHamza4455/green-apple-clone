...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative h-96 overflow-hidden bg-gray-100">
      ...
      {/* Overlay with Header and Description */}
      <div className="absolute z-10 inset-0 flex items-center text-white pt-12 md:pt-16 container mx-auto ">
        <div className="space-y-4 text-left px-4 max-w-6xl container mx-auto">
          ...
          <p className="text-md sm:text-lg font-light flex space-x-2 items-end justify-start">
            ...
            <span>Green Apple Travel & Tourism</span>
          </p>

          {/* Main Heading */}
          <h2 className="text-2xl uppercase sm:text-3xl md:text-4xl max-w-2xl font-extrabold">
            Worldwide Visa & Tours: Your Global Journey Starts Here
          </h2>

          {/* Subtitle */}
          <p className="text-xs sm:text-lg font-light">
            Your trusted partner for visas and tours from the UAE to the world.
          </p>
          ...
          <div>
            ...
            <div className="flex justify-start">
              <a
                ...
                aria-label="Chat with our main office about visa services on WhatsApp"
                title="WhatsApp main office"
                className="text-white inline-flex items-center px-4 py-3 sm:py-2 hover:bg-[#e5eeed] bg-white border border-[#e5eeed] font-semibold text-xs tracking-widest rounded-tl-md shadow-sm focus:outline-none focus:border-[#e5eeed] disabled:opacity-25 transition"
              >
                ...
                <span className="h-6 text-xs text-[rgba(0,118,111,1)] items-center text-opacity-80 leading-3 text-left capitalize hidden md:flex">WhatsApp</span>
              </a>
              ...
              <a
                ...
                className="text-white inline-flex items-center px-4 py-3 sm:py-2 hover:bg-[#e5eeed] bg-white border border-[#e5eeed] font-semibold text-xs tracking-widest shadow-sm focus:outline-none focus:border-[#e5eeed] disabled:opacity-25 transition"
              >
                ...
                <span className="h-6 text-xs text-[rgba(0,118,111,1)] items-center text-opacity-80 leading-3 text-left capitalize hidden md:flex">Call</span>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Main office location near Burjuman Metro"
                title="Location near Burjuman Metro"
                className="items-center hover:bg-[#e5eeed] bg-white border border-[#e5eeed] disabled:opacity-25 focus:border-[#e5eeed] focus:outline-none font-semibold inline-flex w-60 p-1 rounded-tr-md shadow-sm sm:px-4 py-2 text-white text-xs tracking-widest transition"
              >
                ...
                <span className="flex h-6 text-xs text-[rgba(0,118,111,1)] text-opacity-80 leading-3 text-left capitalize">Near Burjuman Metro</span>
              </a>
            </div>
            ...
            <div className="flex justify-start">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Chat with our branch office about visa services on WhatsApp"
                title="WhatsApp branch office"
                className="text-white inline-flex items-center px-4 py-3 sm:py-2 hover:bg-[#e5eeed] bg-white border border-[#e5eeed] font-semibold text-xs tracking-widest rounded-bl-md shadow-sm focus:outline-none focus:border-[#e5eeed] disabled:opacity-25 transition"
              >
                <svg className="h-4 w-4 sm:h-6 sm:w-6 mr-2 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                  <path fill="#005752" d="M16.004,31c-2.868,0-5.646-0.811-8.05-2.347l-5.348,1.709c-0.179,0.057-0.376,0.009-0.509-0.125c-0.132-0.134-0.178-0.332-0.117-0.51l1.725-5.146C1.935,22.061,1,19.1,1,16c0-4.076,1.612-7.891,4.539-10.742C5.736,5.066,6.053,5.07,6.246,5.267c0.192,0.198,0.188,0.515-0.01,0.707C3.505,8.636,2,12.196,2,16c0,2.974,0.922,5.811,2.665,8.204c0.095,0.131,0.121,0.3,0.069,0.454l-1.492,4.452l4.633-1.481c0.144-0.047,0.302-0.024,0.429,0.059C10.589,29.2,13.252,30,16.004,30C23.722,30,30,23.72,30,16c0-7.719-6.278-14-13.996-14c-2.167,0-4.238,0.481-6.164,1.429C9.589,3.55,9.29,3.449,9.168,3.202S9.147,2.654,9.396,2.532C11.46,1.516,13.682,1,15.996,1C24.272,1,31,7.729,31,16S24.272,31,16.004,31z"></path>
                  <path fill="#005752" d="M20.602,24.493c-1.011,0-2.422-0.39-4.439-1.226c-2.633-1.09-5.243-3.374-7.35-6.429c-0.696-0.951-1.823-2.773-1.823-4.675c0-2.229,1.115-3.36,1.592-3.843c0.449-0.461,1.12-0.706,1.874-0.706c0.19,0,0.36,0.009,0.515,0.018c0.635,0.025,1.003,0.185,1.353,1.022l0.363,0.88c0.384,0.931,0.857,2.08,0.931,2.235c0.082,0.169,0.331,0.688,0.054,1.228c-0.148,0.316-0.293,0.483-0.492,0.713c-0.14,0.161-0.233,0.261-0.328,0.361c-0.11,0.118-0.222,0.234-0.334,0.375c-0.193,0.226-0.193,0.226-0.128,0.339c0.37,0.625,1.157,1.825,2.253,2.8c1.422,1.265,2.571,1.73,3.123,1.954l0.137,0.056c0.145,0.06,0.328,0.103,0.465-0.042c0.248-0.267,0.562-0.706,0.894-1.171l0.199-0.279c0.349-0.493,0.779-0.597,1.078-0.597c0.175,0,0.357,0.035,0.543,0.105c0.465,0.162,2.912,1.381,2.937,1.393l0.235,0.115c0.35,0.168,0.626,0.301,0.784,0.579c0.229,0.398,0.139,1.442-0.209,2.427c-0.417,1.179-1.967,2.1-3.213,2.368C21.293,24.438,20.998,24.493,20.602,24.493z"></path>
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Call our branch office"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Branch office location near World Trade Metro"
                title="Location near World Trade Metro"
                className="items-center hover:bg-[#e5eeed] bg-white border border-[#e5eeed] disabled:opacity-25 focus:border-[#e5eeed] focus:outline-none font-semibold inline-flex w-60 p-1 rounded-br-md shadow-sm sm:px-4 py-2 text-white text-xs tracking-widest transition"
              >
                <svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" className="fill-current h-4 w-4 sm:h-6 sm:w-6 mr-2">
                  <line stroke="#005752" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8" x1="56" x2="200" y1="232" y2="232"></line>
                  <circle cx="128" cy="104" r="32" stroke="#005752" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8" fill="none"></circle>
                ...
                <span className="flex h-6 text-xs text-[rgba(0,118,111,1)] text-opacity-80 leading-3 text-left capitalize">Near World Trade Metro</span>
              </a>
            </div>
          </div>
        </div>
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`rounded-full cursor-pointer transition-all duration-300 ${
              index === currentSlide ? 'w-8 h-2 bg-[#33918c]' : 'w-2 h-2 bg-[#33918c]'
            }`}
          />
        ))}
      </div>
