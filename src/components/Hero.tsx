    ...
    },
    {
      ...
      icon: (
        <svg
          viewBox="0 0 256 256"
          xmlns="http://www.w3.org/2000/svg"
          className="fill-current h-4 w-4 sm:h-6 sm:w-6 mr-2"
        >
          <line
            stroke="#005752"
            strokeLinecap="round"
