...
export default function WhyChooseUs() {
    ...
    return (
        <section id="why-choose-us" className="w-full py-16 px-4 bg-white">
            <div className="max-w-7xl mx-auto">
                {/* Headline */}
                <div className="text-center mb-16">
                    <h2 className="text-4xl md:text-5xl font-bold mb-4" style={{color: '#FF4E00'}}>
                        Why Radiant Way Travel?
                        <span className="block w-16 h-1 mx-auto mt-2" style={{backgroundColor: '#FF4E00'}}></span>
                    </h2>
                    <p className="text-xl" style={{color: 'black'}}>Effortless Journeys. Lasting Memories.</p>
                </div>
                            ...
                            >
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm leading-relaxed" style={{color: 'black', opacity: 0.8}}>
                                            {feature.description}
                                        </p>
                                    </div>
                                </div>
