...
export default function FeaturedTours() {
    ...
    const fetchFeaturedTours = async () => {
      try {
        ...
        const response = await fetch(
          "/api/tour-packages?featured=true&status=active",
        );
        if (!response.ok) {
        ...
        setError(
          err instanceof Error ? err.message : "Failed to load featured tours",
        );
      } finally {
        setLoading(false);
      }
  ...
  return (
    <section
      ...
      aria-labelledby="featured-tours"
    >
      {/* Featured Tours */}
      <div className="max-w-7xl mx-auto py-12 px-4">
        ...
        >
          ...
          {!allToursVisible && (
            <div
              className="w-full bg-gray-200 rounded-full mb-4 overflow-hidden"
              style={{ height: "3px" }}
            >
              <div
            ...
            {loading ? (
              ...
              <div className="w-full text-center py-12">
                ...
                <div className="text-gray-400 text-sm mt-2">
                  Check back later for featured tour packages
                </div>
              </div>
            ) : (
              // Featured tours
