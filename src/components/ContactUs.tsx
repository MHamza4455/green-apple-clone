    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <div
            className="h-1 w-32 mx-auto mt-6 rounded"
            ...
            <div>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-2xl border border-gray-200">
                <p className="text-black leading-relaxed text-sm">
                  All visas are issued at the sole discretion of their
                  respective Governments, and we can not guarantee any visa
                  issuance. We do not have any affiliation with any government
                  agency. All visas can be applied personally by using their
                  respective Government websites or by visiting their Embassy or
                  Consulate for which you will not be charged for service fee.
                </p>
              </div>
            </div>
          </div>
