              ...
              <form className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select className="w-full p-4 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[rgba(0,140,149,0.3)] focus:border-[rgba(0,140,149,1)] transition-all duration-300">
                ...
                <button
                  type="submit"
                  className="w-full text-white py-4 px-8 rounded-xl font-semibold text-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300 transform"
                  style={{ backgroundColor: 'rgba(255, 213, 90, 1)' }}
                  onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'rgba(255, 213, 90, 0.8)'}
                  onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'rgba(255, 213, 90, 1)'}
                >
                  Send Message
                </button>
              </form>
