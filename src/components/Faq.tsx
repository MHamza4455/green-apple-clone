  ...
  const faqs: FAQ[] = [
    {
      ...
      answer: 'Yes, all our packages include return flights from major UAE airports, ensuring a seamless travel experience from start to finish.',
      category: 'general'
    },
    {
      id: 2,
      question: 'Are the hotels central/close to attractions?',
      answer: 'Yes, we carefully select hotels that are centrally located and close to major attractions, offering both comfort and convenience.',
      category: 'general'
    },
    {
      id: 3,
      question: 'Do you help with visa applications?',
      answer: 'Yes, we provide full support for visa applications, including USA, UK, Schengen, Canada, Australia, and New Zealand. Our team guides you through the entire process.',
      category: 'visa'
    },
    {
      id: 4,
      question: 'Can I book for solo travellers or families?',
      answer: 'Yes, our packages are flexible and can be tailored for solo travelers, families, or groups, ensuring everyone enjoys a smooth and memorable journey.',
      category: 'tours'
    },
    {
      id: 5,
      question: 'Do you offer installment payment options?',
      answer: 'Yes, we offer easy installment plans. You can secure your booking with a small deposit and pay the remaining amount through flexible installments before departure.',
      category: 'general'
    }
  ];
