  ...
  const slides = [
    {
      ...
      description:
        "4★ Hotel · Breakfast · Transfers · Explore Yerevan, Lake Sevan, Pearl of Armenia",
      buttonText: "Book Now",
      thumbTitle: "Armenia",
    ...
    },
    {
      ...
      description:
        "4★ Hotel · Breakfast · Transfers · Visit Blue Mosque, Hagia Sophia, Topkapi Palace, Grand Bazaar",
      buttonText: "Book Now",
      thumbTitle: "Istanbul",
    ...
    },
    {
      ...
      description:
        "4★ Hotel · Breakfast · Transfers · Explore Moscow, Red Square, Pushkin Museum",
      buttonText: "Book Now",
      thumbTitle: "Russia",
      href: "#russia-package",
    },
  ...
  const handleContentLeave = () => {
    ...
    if (mainSwiperRef.current?.swiper && hoveredThumb === null) {
      ...
      progressStartTime.current =
        Date.now() - (pausedProgress.current / 100) * progressDuration;
    }
  };
      ...
      >
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, #FF4E00 0%, transparent 70%)",
                  ...
                  >
                    ...
                    {index === activeIndex && (
                      <motion.div
                        ...
                        style={{
                          background:
                            "linear-gradient(90deg, #30D5C8 0%, #40E0D0 50%, #FF4E00 100%)",
                        }}
                        initial={{ width: 0 }}
