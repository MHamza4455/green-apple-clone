      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
        ...
        <div className="flex flex-col justify-between space-y-6 text-center md:text-left md:col-span-1">
          ...
          <div className="flex flex-col items-baseline space-y-4 text-left">
            ...
            <p className="text-sm text-opacity-80 font-medium" style={{ color: 'rgba(0,140,149,1)', opacity: 0.9 }}>
              Join the <span className="font-bold" style={{ color: 'rgba(0,140,149,1)', opacity: 0.9 }}>78,000+</span> travelers who&apos;ve let us handle their dream trips!
            </p>
          </div>
        </div>
        {/* Right Section - Cards */}
        <div className="md:col-span-2 grid grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="bg-white p-6 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col items-start border border-gray-100 hover:border-primary/20 group">
            ...
            <h3 className="text-base sm:text-lg font-bold text-left uppercase mb-3" style={{ color: 'rgba(0,140,149,1)', opacity: 0.9 }}>12+ Years of Expertise</h3>
            <p className="text-sm text-left leading-relaxed" style={{ color: 'rgba(0,140,149,1)', opacity: 0.8 }}>Trust your travel plans to a team with over a decade of experience in the industry.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col items-start border border-gray-100 hover:border-primary/20 group">
            <div className="text-primary mb-6 bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-2xl group-hover:from-primary/5 group-hover:to-primary/10 transition-all duration-300">
              {/* Icon SVG for Card 2 */}
              <svg className="w-8 h-8" fill="currentColor" style={{color: 'rgba(0,140,149,1)', opacity: 0.9}} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <g>
                  <g>
            ...
            <h3 className="text-base sm:text-lg font-bold text-left uppercase mb-3" style={{ color: 'rgba(0,140,149,1)', opacity: 0.9 }}>Seamless visa services</h3>
            <p className="text-sm text-left leading-relaxed" style={{ color: 'rgba(0,140,149,1)', opacity: 0.8 }}>Enjoy hassle-free travel with our dedicated visa assistance.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col items-start border border-gray-100 hover:border-primary/20 group">
            <div className="text-primary mb-6 bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-2xl group-hover:from-primary/5 group-hover:to-primary/10 transition-all duration-300">
              {/* Icon SVG for Card 3 */}
              <svg className="w-8 h-8 fill-current" style={{ color: 'rgba(0,140,149,1)', opacity: 0.9 }} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
            ...
            <h3 className="text-base sm:text-lg font-bold text-left uppercase mb-3" style={{ color: 'rgba(0,140,149,1)', opacity: 0.9 }}>Tailored packages for every traveler</h3>
            <p className="text-sm text-left leading-relaxed" style={{ color: 'rgba(0,140,149,1)', opacity: 0.8 }}>Discover tours designed to meet diverse interests.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col items-start border border-gray-100 hover:border-primary/20 group">
            <div className="text-primary mb-6 bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-2xl group-hover:from-primary/5 group-hover:to-primary/10 transition-all duration-300">
              {/* Icon SVG for Card 4 */}
              <svg className="w-8 h-8 fill-current" style={{ color: 'rgba(0,140,149,1)', opacity: 0.9 }} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            <h3 className="text-base sm:text-lg font-bold text-left uppercase mb-3" style={{ color: 'rgba(0,140,149,1)', opacity: 0.9 }}>24/7 customer support</h3>
            <p className="text-sm text-left leading-relaxed" style={{ color: 'rgba(0,140,149,1)', opacity: 0.8 }}>Travel with peace of mind knowing our dedicated team is here for you.</p>
          </div>
        </div>
      </div>
    </section>
