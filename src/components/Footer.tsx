...
export default function Footer() {
  return (
    <footer className="bg-white py-8 px-4" style={{ color: 'rgba(0, 87, 82, .9)' }}>
      <div className="max-w-screen-xl mx-auto grid grid-cols-2 gap-8 md:grid-cols-4">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-start space-x-4">
            <a href="https://www.instagram.com/greenappledxb/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform duration-300">
              ...
              <svg className="w-6 h-6" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" style={{ color: 'rgba(0, 87, 82, .9)' }}>
            ...
            <a href="https://wa.me/97143705995" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform duration-300">
              ...
              <svg className="h-6 w-6" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" style={{ color: 'rgba(0, 87, 82, .9)' }}>
            ...
            <a href="https://facebook.com/greenappledxb" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform duration-300">
              ...
              <svg className="h-6 w-6" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style={{ color: 'rgba(0, 87, 82, .9)' }}>
                <g id="Layer_2">
                  <g>
          ...
          <p className="text-xs font-light" style={{ color: 'rgba(0, 87, 82, 0.8)' }}>
        ...
        <nav aria-labelledby="quick-links" className="space-y-2">
          <h3 id="quick-links" className="font-semibold" style={{ color: 'rgba(0, 87, 82, .9)' }}>Quick Links</h3>
          <ul className="space-y-1 text-sm font-light">
            <li><a href="https://greenappletravel.ae" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'rgba(0, 87, 82, 0.8)' }}>Home</a></li>
            <li><a href="https://greenappletravel.ae/contact-us" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'rgba(0, 87, 82, 0.8)' }}>Contact Us</a></li>
            <li><a href="https://greenappletravel.ae/about-us" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'rgba(0, 87, 82, 0.8)' }}>About Us</a></li>
            <li><a href="https://greenappletravel.ae/privacy-policy" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'rgba(0, 87, 82, 0.8)' }}>Privacy Policy</a></li>
            <li><a href="https://greenappletravel.ae/terms-of-service" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'rgba(0, 87, 82, 0.8)' }}>Terms & Conditions</a></li>
            <li><a href="https://greenappletravel.ae/refpolicy" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'rgba(0, 87, 82, 0.8)' }}>Refund Policy</a></li>
          </ul>
        </nav>

        {/* Contact Information */}
        <aside aria-labelledby="contact-information" className="space-y-4 text-left">
          <h3 id="contact-information" className="font-semibold" style={{ color: 'rgba(0, 87, 82, .9)' }}>Contact Information</h3>
          
          {/* Main Office Contact */}
          <section aria-labelledby="main-office">
            <h4 id="main-office" className="font-medium" style={{ color: 'rgba(0, 87, 82, .9)' }}>Main Office</h4>
            <address className="not-italic">
              <p className="text-sm font-light" style={{ color: 'rgba(0, 87, 82, 0.8)' }}>
          ...
          <section aria-labelledby="branch-office">
            <h4 id="branch-office" className="font-medium" style={{ color: 'rgba(0, 87, 82, .9)' }}>Branch Office</h4>
            <address className="not-italic">
              <p className="text-sm font-light" style={{ color: 'rgba(0, 87, 82, 0.8)' }}>
        ...
        <nav aria-labelledby="support" className="space-y-2">
          <h3 id="support" className="font-semibold" style={{ color: 'rgba(0, 87, 82, .9)' }}>Support</h3>
          <ul className="space-y-1 text-sm font-light">
            <li><a href="tel:+97143705995" target="_blank" rel="noopener noreferrer" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'rgba(0, 87, 82, 0.8)' }}>Company Landline</a></li>
            <li><a href="https://wa.me/97143705995" target="_blank" rel="noopener noreferrer" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'rgba(0, 87, 82, 0.8)' }}>WhatsApp Support</a></li>
          </ul>
          
          <h3 id="services" className="font-semibold" style={{ color: 'rgba(0, 87, 82, .9)' }}>Services</h3>
          <ul className="space-y-1 text-sm font-light">
            <li><a href="https://greenappletravel.ae/visaservices" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'rgba(0, 87, 82, 0.8)' }}>Visa Applications</a></li>
            <li><a href="https://greenappletravel.ae/tour-packages" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'rgba(0, 87, 82, 0.8)' }}>Tour Packages</a></li>
            <li><a href="https://greenappletravel.ae/track-application" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'rgba(0, 87, 82, 0.8)' }}>Track Application</a></li>
          </ul>
        </nav>
      </div>
