...
export default function Footer() {
  return (
    <footer className="py-8 px-4" style={{ backgroundColor: '#30D5C8', color: 'white' }}>
      <div className="max-w-screen-xl mx-auto grid grid-cols-2 gap-8 md:grid-cols-4">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-start space-x-4">
            <a href="https://www.instagram.com/greenappledxb/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform duration-300">
              ...
              <svg className="w-6 h-6" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" style={{ color: 'white' }}>
            ...
            <a href="https://wa.me/97143705995" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform duration-300">
              ...
              <svg className="h-6 w-6" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" style={{ color: 'white' }}>
            ...
            <a href="https://facebook.com/greenappledxb" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform duration-300">
              ...
              <svg className="h-6 w-6" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style={{ color: 'white' }}>
                <g id="Layer_2">
                  <g>
          ...
          <p className="text-xs font-light" style={{ color: 'white', opacity: 0.9 }}>
        ...
        <nav aria-labelledby="quick-links" className="space-y-2">
          <h3 id="quick-links" className="font-semibold" style={{ color: '#FF4E00' }}>Quick Links</h3>
          <ul className="space-y-1 text-sm font-light">
            <li><a href="#" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'white' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#40E0D0'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'white'}>Home</a></li>
            <li><a href="#contact" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'white' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#40E0D0'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'white'}>Contact Us</a></li>
            <li><a href="#why-choose-us" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'white' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#40E0D0'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'white'}>Why Us</a></li>
          </ul>
        </nav>

        {/* Contact Information */}
        <aside aria-labelledby="contact-information" className="space-y-4 text-left">
          <h3 id="contact-information" className="font-semibold" style={{ color: '#FF4E00' }}>Contact Information</h3>
          
          {/* Main Office Contact */}
          <section aria-labelledby="main-office">
            <h4 id="main-office" className="font-medium" style={{ color: '#FF4E00' }}>Main Office</h4>
            <address className="not-italic">
              <p className="text-sm font-light" style={{ color: 'white' }}>
                Phone: <a href="tel:+97143705995" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'white' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#40E0D0'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'white'}>+971 54 786 1293</a>
              </p>
              <p className="text-sm font-light" style={{ color: 'white' }}>
          ...
          <section aria-labelledby="branch-office">
            <h4 id="branch-office" className="font-medium" style={{ color: '#FF4E00' }}>Branch Office</h4>
            <address className="not-italic">
              <p className="text-sm font-light" style={{ color: 'white' }}>
                Phone: <a href="tel:+97143333221" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'white' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#40E0D0'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'white'}>+971 4 333 3221</a>
              </p>
              <p className="text-sm font-light" style={{ color: 'white' }}>
        ...
        <nav aria-labelledby="support" className="space-y-2">
          <h3 id="support" className="font-semibold" style={{ color: '#FF4E00' }}>Support</h3>
          <ul className="space-y-1 text-sm font-light">
            <li><a href="tel:+97143705995" target="_blank" rel="noopener noreferrer" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'white' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#40E0D0'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'white'}>Company Landline</a></li>
            <li><a href="https://wa.me/97143705995" target="_blank" rel="noopener noreferrer" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'white' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#40E0D0'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'white'}>WhatsApp Support</a></li>
          </ul>
          
          <h3 id="services" className="font-semibold" style={{ color: '#FF4E00' }}>Services</h3>
          <ul className="space-y-1 text-sm font-light">
            <li><a href="#visa-services" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'white' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#40E0D0'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'white'}>Visa Applications</a></li>
            <li><a href="#featured-tours" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'white' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#40E0D0'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'white'}>Tour Packages</a></li>
            <li><a href="#umrah-packages" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'white' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#40E0D0'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'white'}>Umrah Packages</a></li>
          </ul>
        </nav>
      </div>

      {/* Footer Bottom Section */}
      <div className="mt-8 text-xs text-center border-t pt-4" style={{ borderColor: 'rgba(255, 255, 255, 0.2)', color: 'white' }}>
