...
export default function Footer() {
  return (
    <footer className="py-8 px-4" style={{ backgroundColor: 'white', color: 'black' }}>
      <div className="max-w-screen-xl mx-auto grid grid-cols-2 gap-8 md:grid-cols-4">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-start space-x-4">
            <a href="https://www.instagram.com/greenappledxb/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform duration-300">
              <span className="sr-only">Instagram</span>
                <svg className="w-6 h-6" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" style={{ color: 'black' }}>
            ...
            <a href="https://wa.me/97143705995" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform duration-300">
              ...
              <svg className="h-6 w-6" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" style={{ color: 'black' }}>
            ...
            <a href="https://facebook.com/greenappledxb" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform duration-300">
              ...
              <svg className="h-6 w-6" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style={{ color: 'black' }}>
                <g id="Layer_2">
                  <g>
          ...
          <p className="text-xs font-light" style={{ color: 'black', opacity: 0.9 }}>
        ...
        <nav aria-labelledby="quick-links" className="space-y-2">
          ...
          <ul className="space-y-1 text-sm font-light">
            <li><a href="#" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'black' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#FF4E00'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'black'}>Home</a></li>
            <li><a href="#contact" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'black' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#FF4E00'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'black'}>Contact Us</a></li>
            <li><a href="#why-choose-us" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'black' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#FF4E00'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'black'}>Why Us</a></li>
          </ul>
        </nav>
          ...
          <section aria-labelledby="main-office">
            ...
            <address className="not-italic">
              <p className="text-sm font-light" style={{ color: 'black' }}>
                Phone: <a href="tel:+971547861293" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'black' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#FF4E00'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'black'}>+971 54 786 1293</a>
              </p>
              <p className="text-sm font-light" style={{ color: 'black' }}>
        ...
        <nav aria-labelledby="support" className="space-y-2">
          ...
          <ul className="space-y-1 text-sm font-light">
            <li><a href="tel:+97143705995" target="_blank" rel="noopener noreferrer" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'black' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#FF4E00'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'black'}>Company Landline</a></li>
            <li><a href="https://wa.me/97143705995" target="_blank" rel="noopener noreferrer" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'black' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#FF4E00'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'black'}>WhatsApp Support</a></li>
          </ul>
          
          <h3 id="services" className="font-semibold" style={{ color: '#FF4E00' }}>Services</h3>
          <ul className="space-y-1 text-sm font-light">
            <li><a href="#visa-services" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'black' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#FF4E00'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'black'}>Visa Applications</a></li>
            <li><a href="#featured-tours" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'black' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#FF4E00'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'black'}>Tour Packages</a></li>
            <li><a href="#umrah-packages" className="hover:opacity-75 transition-opacity duration-300" style={{ color: 'black' }} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#FF4E00'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = 'black'}>Umrah Packages</a></li>
          </ul>
        </nav>
      </div>

      {/* Footer Bottom Section */}
      <div className="mt-8 text-xs text-center border-t pt-4" style={{ borderColor: 'rgba(0, 0, 0, 0.2)', color: 'black' }}>
