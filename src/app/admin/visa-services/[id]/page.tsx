    ...
    return (
      <div className="p-6">
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-6">The visa service you're looking for doesn't exist.</p>
          <button
    ...
    <div className="p-6">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            onClick={() => router.push(`/admin/visa-services/${visaService.id}/edit`)}
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Visa Service Details</h1>
        <p className="text-gray-600">View and manage visa service information</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">{visaService.name}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-orange-600 font-semibold">{visaService.price}</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-3">Service Info</h3>
                <div className="space-y-2">
                  <div className="flex justify-between">
        ...
        <div className="space-y-6">
          ...
          {/* Documents Provided */}
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Documents Provided</h3>
            <div className="space-y-2">
