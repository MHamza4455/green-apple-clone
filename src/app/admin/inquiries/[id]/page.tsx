    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600">{inquiry.phone || 'Not provided'}</span>
                  </div>
                </div>
              </div>
              ...
              {inquiry.type === 'VISA' ? (
                <>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600">
                      {inquiry.travelDate ? new Date(inquiry.travelDate).toLocaleDateString() : 'Not specified'}
                    </span>
                  </div>
                </>
              ) : (
          ...
          {inquiry.message && (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Customer Message</h2>
